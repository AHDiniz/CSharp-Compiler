...
public:
  enum {
    ...
    NAMEOF = 64, NAMESPACE = 65, NEW = 66, NULL = 67, OBJECT = 68, ON = 69, 
  ...
  enum {
    ...
    RuleString_literal = 192, RuleInterpolated_regular_string = 193, RuleInterpolated_verbatium_string = 194, 
    RuleInterpolated_regular_string_part = 195, RuleInterpolated_verbatium_string_part = 196, 
    RuleInterpolated_string_expression = 197, RuleKeyword = 198, RuleClass_definition = 199, 
    RuleStruct_definition = 200, RuleInterface_definition = 201, RuleEnum_definition = 202, 
    RuleDelegate_definition = 203, RuleEvent_declaration = 204, RuleField_declaration = 205, 
    RuleProperty_declaration = 206, RuleConstant_declaration = 207, RuleIndexer_declaration = 208, 
    RuleDestructor_definition = 209, RuleConstructor_declaration = 210, 
    RuleMethod_declaration = 211, RuleMethod_member_name = 212, RuleOperator_declaration = 213, 
    RuleArg_declaration = 214, RuleMethod_invocation = 215, RuleObject_creation_expression = 216, 
    RuleIdentifier = 217
  };
  ...
  public:
    CSharpParser::Primary_expression_startContext *pe = nullptr;
  ...
  public:
    CSharpParser::Qualified_identifierContext *qi = nullptr;
  ...
  public:
    CSharpParser::AttributesContext *attrs = nullptr;
    CSharpParser::Accessor_modifierContext *mods = nullptr;
